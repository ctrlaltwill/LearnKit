...
- **Automatic sync:** runs when editing cards in [Card Browser](./Card-Browser.md) or edit modals.
...
> [!TIP]
> If you remove an anchor by mistake, find the card ID in [Card Browser](./Card-Browser.md) and re-add the line.
