...
Press **Space** or **Enter** to reveal the answer, then grade recall. See [Grading](./Grading.md).
...
|--------|----------|-------------|
| Bury | `B` | Postpone card until tomorrow (see [Burying Cards](./Burying-Cards.md)) |
| Suspend | `S` | Remove card from future reviews (see [Suspending Cards](./Suspending-Cards.md)) |
