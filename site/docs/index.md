...
features:
  - icon: |
    ...
    details: "Build cards your way - write in Markdown or use simple forms, then edit them seamlessly during review or in the flashcard browser."
  - icon: |
  ...
  - icon: |
    ...
    details: "Built-in audio features reinforce your pronunciation and support language learning."
---
