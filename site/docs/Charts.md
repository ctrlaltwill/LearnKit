...
Charts in [Analytics](./Analytics.md) help you understand workload, progress, and retention.
...
If real retention stays below expected, review [Scheduling](./Scheduling.md) settings.
