...
Companion settings are grouped by mode so you can control privacy, prompts, and output behavior.

## Core settings

| Setting | What it controls |
|---------|------------------|
| Enable Companion | Turns companion features on/off globally |
