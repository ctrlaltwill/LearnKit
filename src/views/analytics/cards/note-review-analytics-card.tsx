    ...
    <div className="card sprout-ana-card h-full overflow-visible p-4 flex flex-col gap-3">
      <div className="flex items-start justify-between gap-2">
        ...
        <div ref={wrapRef} className="relative inline-flex">
          <button
            type="button"
            id="sprout-note-review-filter-trigger"
      ...
      {data.length === 0 ? (
        ...
        <>
          ...
          <div className="bc flex flex-wrap gap-3 text-xs text-muted-foreground sprout-ana-chart-legend">
            <div className="bc inline-flex items-center gap-2"><span className="bc inline-block sprout-ana-legend-dot sprout-ana-legend-dot-square" style={{ ["--sprout-legend-color" as string]: "var(--chart-accent-2)" }} />Reviewed</div>
            <div className="bc inline-flex items-center gap-2"><span className="bc inline-block sprout-ana-legend-dot sprout-ana-legend-dot-square" style={{ ["--sprout-legend-color" as string]: "var(--chart-accent-4)" }} />Scheduled</div>
          </div>
        </>
      )}
    </div>
