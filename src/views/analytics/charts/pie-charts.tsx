        ...
        {total > 0 ? (
          <div className="learnkit-analytics-chart">
            ...
            <PieChart isAnimationActive={false}>
              <Tooltip content={<PieTooltip locale={props.locale} />} isAnimationActive={false} />
              <Pie
                data={dataWithColors}
                dataKey="value"
                nameKey="name"
                  ...
                  content={({ viewBox }) => {
                    ...
                    return (
                      <text x={cx} y={cy} textAnchor="middle" dominantBaseline="middle">
                        <tspan x={cx} y={cy - 5} className="fill-foreground text-2xl font-semibold">
                          {value}
                        </tspan>
                        {label ? (
                          <tspan x={cx} y={cy + 17} className="fill-muted-foreground text-xs">
                            {label}
                          </tspan>
                        ) : null}
                      </text>
