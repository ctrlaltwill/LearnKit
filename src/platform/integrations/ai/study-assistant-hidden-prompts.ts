...
const FLASHCARD_HIDDEN_RULES = [
  ...
  "I row guidance (applies to all card types): when included, write I as a simple explanatory back-of-card note in 1-3 sentences.",
  "I row should provide high-yield support for recall: explain why the answer is correct or add concise supporting mechanism/context.",
  "I row must NOT be a learning objective, must NOT repeat the question/answer verbatim, and must NOT include phrasing like 'Learner should' or 'By the end'.",
  "For MCQ cards only, I should briefly contrast why the main wrong options are incorrect when useful.",
  "For non-MCQ cards, do not force wrong-option contrast in I; keep it as direct supporting explanation.",
